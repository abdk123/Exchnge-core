...
{
    public class ReceiptMainAccountClientExchangePartyClientDomainService : ITreasuryActionDomainService
    {
        ...
        public ReceiptMainAccountClientExchangePartyClientDomainService(
