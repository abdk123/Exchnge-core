...
{
    public class ReceiptMainAccountClientExchangePartyCompanyDomainService : ITreasuryActionDomainService
    {
        ...
        public ReceiptMainAccountClientExchangePartyCompanyDomainService(
