...
{
    public class SpendMainAccountExpensesExchangePartyTreasuryDomainService : ITreasuryActionDomainService
    {
        ...
        public SpendMainAccountExpensesExchangePartyTreasuryDomainService(
