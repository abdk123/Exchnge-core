...
{
    public class ReceiptMainAccountCompanyExchangePartyTreasuryDomainService : ITreasuryActionDomainService
    {
        ...
        public ReceiptMainAccountCompanyExchangePartyTreasuryDomainService(
        ...
        {
            return _treasuryActionRepository.GetAllIncluding(ex => ex.MainAccountCompany).FirstOrDefault(x => x.Id == id);
        }
    }
}
