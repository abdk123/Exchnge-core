...
{
    public class SpendMainAccountClientExchangePartyCompanyDomainService : ITreasuryActionDomainService
    {
        ...
        public SpendMainAccountClientExchangePartyCompanyDomainService(
