...
{
    public class ReceiptMainAccountCompanyExchangePartyCompanyDomainService : ITreasuryActionDomainService
    {
        ...
        public ReceiptMainAccountCompanyExchangePartyCompanyDomainService(
