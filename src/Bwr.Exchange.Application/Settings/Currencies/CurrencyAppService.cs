...
namespace Bwr.Exchange.Settings.Currencies
{
    ...
    {
        private readonly ICurrencyManager _countryManager;
        ...
        {
            var country = AsyncHelper.RunSync(() => _countryManager.GetByIdAsync(id));
        ...
        public async Task<CurrencyDto> CreateAsync(CreateCurrencyDto input)
        {
            ...
            var createdCurrency = await _countryManager.InsertAndGetAsync(country);
        ...
        public async Task<CurrencyDto> UpdateAsync(UpdateCurrencyDto input)
        {
            ...
            var updatedCurrency = await _countryManager.UpdateAndGetAsync(country);
