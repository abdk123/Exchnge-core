...
namespace Bwr.Exchange.Migrations
{
    ...
    [Migration("20210818185628_Update_Treasury_Action_Entity")]
    partial class Update_Treasury_Action_Entity
    {
            ...
            modelBuilder.Entity("Bwr.Exchange.TreasuryActions.TreasuryAction", b =>
                {
                    ...
                    b.HasOne("Bwr.Exchange.Transfers.OutgoingTransfer", "OutgoingTransfer")
                        .WithMany()
                        .HasForeignKey("OutgoingTransferId");
