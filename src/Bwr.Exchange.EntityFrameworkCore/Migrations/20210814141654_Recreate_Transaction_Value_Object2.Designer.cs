...
namespace Bwr.Exchange.Migrations
{
    ...
    [Migration("20210814141654_Recreate_Transaction_Value_Object2")]
    partial class Recreate_Transaction_Value_Object2
    {
            ...
            modelBuilder.Entity("Bwr.Exchange.CashFlows.ClientCashFlows.ClientCashFlow", b =>
                {
                    ...
                    b.HasOne("Bwr.Exchange.CashFlows.Transaction", "Transaction")
                        .WithMany()
                        .HasForeignKey("TransactionId", "TransactionType");
                });
